  ...
  useEffect(() => {
    const options = {
      strings: [
        ...
        t('hero.animatedText.ai1') || 'Software Development',
        t('hero.animatedText.ai2') || 'AI Development',
        t('hero.animatedText.openaimodels') || 'Machine Learning',
        t('hero.animatedText.openai') || 'Software Development',
        t('hero.animatedText.tts') || 'AI Development',
        t('hero.animatedText.stt') || 'Machine Learning',
        t('hero.animatedText.avs') || 'Software Development',
        t('hero.animatedText.aiorch') || 'AI Development',
        t('hero.animatedText.dataScience') || 'Machine Learning',
        t('hero.animatedText.cloudTechnology') || 'Software Development',
        ...
        t('hero.animatedText.ciCd') || 'Machine Learning',
        t('hero.animatedText.paymentGateway') || 'Software Development',
