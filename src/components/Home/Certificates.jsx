  ...
  return (
    <div className='main-cert' style={{ direction: currentLang === 'ar' ? 'rtl' : 'ltr' }}>
      ...
      <div className="right-cert">
        <div className="card-cert"><img src="/images/Certificates/1.png" alt="Certificate" /></div>
        <div className="card-cert"><img src="/images/Certificates/2.png" alt="Certificate" /></div>
        <div className="card-cert"><img src="/images/Certificates/3.svg" alt="Certificate" /></div>
        <div className="card-cert"><img src="/images/Certificates/4.png" alt="Certificate" /></div>
        <div className="card-cert"><img src="/images/Certificates/5.png" alt="Certificate" /></div>
        <div className="card-cert"><img src="/images/Certificates/6.png" alt="Certificate" /></div>
      </div>
    </div>
  );
}
